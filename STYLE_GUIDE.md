# Style Guide for Latin - Cyrillic Converter

This document outlines the coding style and conventions to follow for the **Latin - Cyrillic Converter** project. Consistent code style helps improve readability and maintainability.
